...
import static org.firstinspires.ftc.teamcode.tuning.roboConstants.LauncherConstants.autoCenterShootingVelocity;
...
import org.firstinspires.ftc.teamcode.opmodes.auto.Paths.redOneGateCycleAutoPaths;
...
@Autonomous(name = "redCloseOneGateCycle", group = ".")
public class redOneCycleGateAuto extends LinearOpMode {
    ...
    private double shootingVal = autoCenterShootingVelocity;
    ...
    public void runOpMode(){
        ...
        redOneGateCycleAutoPaths paths = new redOneGateCycleAutoPaths(follower);
