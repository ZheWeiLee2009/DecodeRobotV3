...
//        launcher.setFlywheelsVelocity(shootingVal);
        ...
        try {
            ...
            releaseALl();
//
//            telemetry.addData("PosX", follower.getPose().getX());
//            telemetry.addData("PosY", follower.getPose().getY());
//            telemetry.addData("PosHeading", Math.toDegrees(follower.getPose().getHeading()));
//            telemetry.update();
//
//            sleep(30000);
